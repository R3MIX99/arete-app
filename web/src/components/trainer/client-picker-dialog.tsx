  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
         ...
         * siempre arranca limpia, sin necesitar un efecto que sincronice
         * el estado al abrir. */}
        {open && (
          <ClientPickerDialogBody clients={clients} onPick={onPick} onOpenChange={onOpenChange} />
        )}
      </DialogContent>
    </Dialog>
  );
...
function ClientPickerDialogBody({
  clients,
  onPick,
  onOpenChange,
}: {
