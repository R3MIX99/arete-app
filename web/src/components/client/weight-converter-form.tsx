 ...
 * de la serie — no está atado a ningún ejercicio en particular, así que
 * el mismo formulario sirve para cualquiera.
 *
 * Vive en su propia página (no en un drawer/modal): con dos inputs más
 * el switch de "usé barra", el teclado numérico del teléfono empujaba
 * todo el contenido del drawer y el layout se veía roto. Como página de
 * verdad no tiene ese problema.
 */
export function WeightConverterForm() {
